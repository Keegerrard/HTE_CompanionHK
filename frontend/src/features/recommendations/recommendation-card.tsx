      ...
      <CardContent className="flex flex-col gap-3 p-4">
        ...
        <div className="flex flex-wrap gap-1.5">
          ...
          {recommendation.user_ratings_total != null && (
            <Badge variant="outline" className="rounded-full border-border/60 text-xs font-medium">
        ...
        {/* Rationale */}
        <p className="text-sm leading-relaxed text-muted-foreground">{recommendation.rationale}</p>
